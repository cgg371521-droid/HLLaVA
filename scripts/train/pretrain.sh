...
deepspeed --include localhost:1 --master_port 29501 tinyllava/train/train.py \
    ...
    --output_dir /root/Desktop/code/TinyLLAVA/TinyLLaVA_Factory-main/output/tiny-llava-${LLM_VARIANT}-${VT_VARIANT}-${VERSION}-pretrain \
    --num_train_epochs 1 \
